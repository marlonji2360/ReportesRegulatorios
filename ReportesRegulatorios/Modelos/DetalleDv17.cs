    ...
    internal class DetalleDv17
    {
        ...
        public DataTable ObtenerDetalleTxt(int anioMes, string tipoConexion)
        {
            ...
            string consulta = @"SELECT  LEFT(CONVERT(CHAR(8), Fecha_Transaccion, 112) + REPLICATE(' ', 8), 8)  + '&&' +
                                        ...
                                        REPLACE(LEFT(CAST(CAST(Monto_Moneda_Orginal AS DECIMAL(38,2)) AS VARCHAR(14)) + REPLICATE(' ', 14), 14),'.00','   ')   + '&&' +
                                        REPLACE(LEFT(CAST(CAST(Monto_Dolares AS DECIMAL(38,2)) AS VARCHAR(14)) + REPLICATE(' ', 14), 14),'.00','   ')    + '&&' +                                        
        ...
        public bool InsertarDetalleDv17Bulk(DataTable dataTable, string tipoConexion)
        {
            try
            {
        ...
        public bool InsertarDetalleDv17(DataTable dataTable, string tipoConexion)
        {
            try
            {
                if(tipoConexion == "Principal")
