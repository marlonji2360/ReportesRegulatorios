...
namespace ReportesRegulatorios.Modelos
{
    internal class EncaEf14
    {
        ...
        public DataTable ObtenerEncabezado(int anioMes)
        {
            ...
            string consulta = "select AnioMes, Estado, Usuario_genera, Fecha_genera, Usuario_upd, Fecha_upd, Usuario_Cierre, Fecha_Cierre, Doc_cierre from DL_CUMPLIMIENTO.dw_repreg_ef14_deta_enca where AnioMes=" + anioMes;
            try
            {
