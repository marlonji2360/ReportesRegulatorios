...
namespace ReportesRegulatorios.Modelos
{
    internal class EncaBa12
    {
        ...
        public DataTable ObtenerEncabezado(int anioMes)
        {
            ...
            string consulta = "select AnioMes, Estado, Usuario_genera, Fecha_genera, Usuario_upd, Fecha_upd, Usuario_Cierre, Fecha_Cierre, Doc_cierre from DL_CUMPLIMIENTO.dw_repreg_ba12_deta_enca where AnioMes=" + anioMes;
            try
            {
                                            ...
                                            )
        {
            try
            {
                ...
                using (SqlConnection conn = conexion.AbrirConexion())
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("DL_CUMPLIMIENTO.PRC_Actualizar_BA12_ENCA", conn))
                    {
