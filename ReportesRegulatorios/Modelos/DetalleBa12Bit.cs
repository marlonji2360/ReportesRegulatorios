...
namespace ReportesRegulatorios.Modelos
{
    internal class DetalleBa12Bit
    {
        ...
        public bool InsertarDetalleBa12BitBulk(DataTable dataTable, string usuario, string tipoConexion)
        {
            try
            {
        ...
        public bool InsertarDetalleBa12VerBitBulk(DataTable dataTable, string usuario, string tipoConexion)
        {
            try
            {
                //Agregamos columas para empatarla con la bitacora
        ...
        public DataTable InsertarNuevosEnDetalle(int anioMes, string tipoConexion)
        {
            ...
            string consulta = @"SELECT * FROM DL_CUMPLIMIENTO.dw_repreg_ba12_deta_bit WHERE AnioMes = @AnioMes and tipo = 'NUEVO' AND EstadoBitacora ='P'";
        ...
        {
            string consulta = @"UPDATE EDW.DL_CUMPLIMIENTO.dw_repreg_ba12_deta_bit 
