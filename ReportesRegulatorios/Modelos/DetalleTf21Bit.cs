...
namespace ReportesRegulatorios.Modelos
{
    internal class DetalleTf21Bit
    {
        ...
        public bool InsertarDetalleTf21BitBulk(DataTable dataTable, string usuario, string tipoConexion)
        {
            try
            {
        ...
        public bool InsertarDetalleTf21VerBitBulk(DataTable dataTable, string usuario, string tipoConexion)
        {
            try
            {
                //Agregamos columas para empatarla con la bitacora
